"""
Vision processing utilities for Qwen2.5-VL models.

This module contains vision processing utilities adapted from the official Qwen2.5-VL repository.
Original source: https://github.com/QwenLM/Qwen2.5-VL/tree/main/qwen-vl-utils

The Qwen2.5-VL repository is licensed under the Apache License, Version 2.0.
Developed by Qwen team, Alibaba Cloud.

Adapted for local use to remove external dependency on qwen-vl-utils package.
"""
