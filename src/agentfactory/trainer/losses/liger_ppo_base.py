"""
This file is modified from https://github.com/linkedin/Liger-Kernel/blob/02bac056330eb06711ef5dbb0325cc2087702a3d/src/liger_kernel/chunked_loss/fused_linear_ppo.py
"""
...
class LigerFusedLinearPPOBase(torch.autograd.Function):
    ...
    def forward(
        ...
        if compiled:
            ...
            fused_fwd_bwd = torch.compile(fused_fwd_bwd, dynamic=True)
