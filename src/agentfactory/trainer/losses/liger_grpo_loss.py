"""
This file is modified from https://github.com/linkedin/Liger-Kernel/blob/02bac056330eb06711ef5dbb0325cc2087702a3d/src/liger_kernel/chunked_loss/grpo_loss.py
"""
from typing import Optional

import torch

from .liger_ppo_base import LigerFusedLinearPPOBase
    ...
    def ppo_loss_fn(
        ...
        **kwargs,
        ...
        if loss_type == "grpo":
            ...
            # divide by num tokens in batch to normalize the loss
            loss = (per_token_loss * attention_mask).sum() / max_completion_length
        else:
